...
foreach my $entry(@all_entries){
  ...
  ok(!$entry->bibtex_has_field("test"));
  ...
  if( $entry->bibtex_has_field('month') ){
  ...
  if( $entry->bibtex_has_field('author') or $entry->bibtex_has_field('editor') ){
  ...
  if( $entry->bibtex_has_field('tags') ){
