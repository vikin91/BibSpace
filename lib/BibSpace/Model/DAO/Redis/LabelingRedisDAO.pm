...
package BibSpace::Model::DAO::Redis::LabelingRedisDAO;

use namespace::autoclean;
use Moose;
use BibSpace::Model::DAO::Interface::ILabelingDAO;
use BibSpace::Model::Labeling;
with 'BibSpace::Model::DAO::Interface::ILabelingDAO';

# Inherited fields from BibSpace::Model::DAO::Interface::ILabelingDAO Mixin:
