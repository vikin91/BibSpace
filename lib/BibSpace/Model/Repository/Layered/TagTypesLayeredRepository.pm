...
sub all {
    ...
    my @result;
    try{
        @result = $self->backendFactory->getInstance( $daoFactoryType, $daoBackendHandle )->getTagTypeDao()->all();
    }
    catch{
        print;
    };
...
sub filter {
    ...
    my $daoBackendHandle = $self->_getReadBackend()->{'handle'};
    try{
        @result = $self->backendFactory->getInstance( $daoFactoryType, $daoBackendHandle )->getTagTypeDao()->filter( $coderef );
    }
    catch{
        print;
    };
...
sub find {
    ...
    my $daoBackendHandle = $self->_getReadBackend()->{'handle'};
    try{
        @result = $self->backendFactory->getInstance( $daoFactoryType, $daoBackendHandle )->getTagTypeDao()->find( $coderef );
    }
    catch{
        print;
    };
...
sub count {
    ...
    my $daoBackendHandle = $self->_getReadBackend()->{'handle'};
    try{
        @result = $self->backendFactory->getInstance( $daoFactoryType, $daoBackendHandle )->getTagTypeDao()->count( $coderef );
    }
    catch{
        print;
    };
