...
sub all {
    ...
    my @result;
    try{
        @result = $self->backendFactory->getInstance( $daoFactoryType, $daoBackendHandle )->getAuthorDao()->all();
    }
    catch{
        print;
    };
...
sub filter {
    ...
    my $daoBackendHandle = $self->_getReadBackend()->{'handle'};
    try{
        @result = $self->backendFactory->getInstance( $daoFactoryType, $daoBackendHandle )->getAuthorDao()->filter( $coderef );
    }
    catch{
        print;
    };
...
sub find {
    ...
    my $daoBackendHandle = $self->_getReadBackend()->{'handle'};
    try{
        @result = $self->backendFactory->getInstance( $daoFactoryType, $daoBackendHandle )->getAuthorDao()->find( $coderef );
    }
    catch{
        print;
    };
...
sub count {
    ...
    my $daoBackendHandle = $self->_getReadBackend()->{'handle'};
    try{
        @result = $self->backendFactory->getInstance( $daoFactoryType, $daoBackendHandle )->getAuthorDao()->count( $coderef );
    }
    catch{
        print;
    };
