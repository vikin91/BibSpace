...
sub copy{
    ...
    $self->logger->info("Copying all Tag from layer $fromLayer to layer $toLayer.","".__PACKAGE__."->copy");
    ...
    $self->logger->info(scalar(@resultRead)." Tag read from layer $fromLayer.","".__PACKAGE__."->copy");
    ...
    $self->logger->info(" $resultSave Tag saved to layer $toLayer.","".__PACKAGE__."->copy");
}
