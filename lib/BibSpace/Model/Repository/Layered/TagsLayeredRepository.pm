...
sub copy{
    ...
    $self->logger->debug("Copying all Tag from layer $fromLayer to layer $toLayer.","".__PACKAGE__."->copy");
    ...
    )->getTagDao($self->idProvider)->save( @resultRead );
