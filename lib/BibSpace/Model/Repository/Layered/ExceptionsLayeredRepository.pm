...
sub all {
    ...
    my @result;
    try{
        @result = $self->backendFactory->getInstance( $daoFactoryType, $daoBackendHandle )->getExceptionDao()->all();
    }
    catch{
        print;
    };
...
sub filter {
    ...
    my $daoBackendHandle = $self->_getReadBackend()->{'handle'};
    try{
        @result = $self->backendFactory->getInstance( $daoFactoryType, $daoBackendHandle )->getExceptionDao()->filter( $coderef );
    }
    catch{
        print;
    };
...
sub find {
    ...
    my $daoBackendHandle = $self->_getReadBackend()->{'handle'};
    try{
        @result = $self->backendFactory->getInstance( $daoFactoryType, $daoBackendHandle )->getExceptionDao()->find( $coderef );
    }
    catch{
        print;
    };
...
sub count {
    ...
    my $daoBackendHandle = $self->_getReadBackend()->{'handle'};
    try{
        @result = $self->backendFactory->getInstance( $daoFactoryType, $daoBackendHandle )->getExceptionDao()->count( $coderef );
    }
    catch{
        print;
    };
