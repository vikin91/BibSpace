...
sub save {
    ...
    foreach my $backendDAO ( $self->getBackendsArray() ){
        ...
        try{
            return $self->backendFactory->getInstance( $daoFactoryType, $daoBackendHandle )->getTeamDao()->save( @objects );
        }
        catch{
            print;
        };
...
sub update {
    ...
    foreach my $backendDAO ( $self->getBackendsArray() ){
        ...
        my $daoBackendHandle = $backendDAO->{'handle'};
        try{
            return $self->backendFactory->getInstance( $daoFactoryType, $daoBackendHandle )->getTeamDao()->update( @objects );
        }
        catch{
            print;
        };
...
sub delete {
    ...
    foreach my $backendDAO ( $self->getBackendsArray() ){
        ...
        my $daoBackendHandle = $backendDAO->{'handle'};
        try{
            return $self->backendFactory->getInstance( $daoFactoryType, $daoBackendHandle )->getTeamDao()->delete( @objects );
        }
        catch{
            print;
        };
...
sub filter {
    ...
    my $daoBackendHandle = $self->_getReadBackend()->{'handle'};
    try{
        return $self->backendFactory->getInstance( $daoFactoryType, $daoBackendHandle )->getTeamDao()->filter( $coderef );
    }
    catch{
        print;
    };
...
sub find {
    ...
    my $daoBackendHandle = $self->_getReadBackend()->{'handle'};
    try{
        return $self->backendFactory->getInstance( $daoFactoryType, $daoBackendHandle )->getTeamDao()->find( $coderef );
    }
    catch{
        print;
    };
