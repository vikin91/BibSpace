use utf8;
package Hex64Publications::Schema::Result::Entry;
...
Related object: L<Hex64Publications::Schema::Result::EntryToTag>

=cut

__PACKAGE__->has_many(
  "entries_to_tag",
  "Hex64Publications::Schema::Result::EntryToTag",
...
Related object: L<Hex64Publications::Schema::Result::EntryToAuthor>

=cut

__PACKAGE__->has_many(
  "entry_to_authors",
  "Hex64Publications::Schema::Result::EntryToAuthor",
  { "foreign.entry_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Hex64Publications::Schema::Result::ExceptionsEntryToTeam>
