...
sub register {
    ...
    #     # TODO: Anti-pattern. Do it with template!!

    #     my $hlp = `
    #         <td style="width: 120px;">
    #                 <div class="btn-group">
    #                     <a class="btn btn-warning" href="<%= url_for('/publications/manage_tags/')%><%= $obj->{id} %><%=$burl%>"><span class="glyphicon glyphicon-tags"></span> T</a>
    #                     <button type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown">
    #                     <span class="glyphicon glyphicon-pencil"></span>
    #                     <span class="caret"></span>
    #                     </button>
    #                     <ul class="dropdown-menu" role="menu">
    #                         <li><a href="<%= url_for('/publications/edit/')%><%=$obj->{id}%><%=$burl%>"><span class="glyphicon glyphicon-pencil" style="color: #5CB85C;"></span> Edit BibTeX</a></li>
    #                         <li><a href="#modal-dialog-<%=$obj->{id}%>" data-toggle="modal"><span class="glyphicon glyphicon-trash"></span> Delete...</a></li>
    #                         <li><a href="<%= url_for('/publications/show_authors/')%><%=$obj->{id}%><%=$burl%>"><span class="glyphicon glyphicon-user"></span> Show authors</a></li>
    #                         <li><a href="<%= url_for('/publications/regenerate/')%><%=$obj->{id}%><%=$burl%>"><span class="glyphicon glyphicon-refresh" style="color: #5CB85C;"></span> Regenerate HTML</a></li>
    #                         <li><a href="<%= url_for('/publications/add_pdf/')%><%=$obj->{id}%><%=$burl%>"><i class="fa fa-upload"></i><i class="fa fa-file-pdf-o"></i><i class="fa fa-file-powerpoint-o"></i> Upload pdf/slides</a></li>
    #                         <li><a href="<%= url_for('/publications/manage_tags/')%><%=$obj->{id}%><%=$burl%>"><span class="glyphicon glyphicon-tags"></span> Manage tags</a></li>
    #                         <li><a href="<%= url_for('/publications/manage_exceptions/')%><%=$obj->{id}%><%=$burl%>"><i class="fa fa-exclamation "></i> Manage exceptions</a></li>
    #                     </ul>
    #                 </div>
    ...
    #                                     <a href="<%= url_for('/publications/delete_sure/')%><%=$obj->{id}%><%=$burl%>" class="btn btn-danger"> Yes, delete it <span class="glyphicon glyphicon-trash"></span></a>
    ...
    #                     <a class="btn <%=$t1%> btn-sm" href="<%= url_for('/publications/make_paper/')%><%= $obj->{id} %><%=$burl%>" data-toggle="tooltip" data-placement="top" title="Click to set entry type to PAPER" data-container="body">
    #                             <span class="glyphicon glyphicon-file"></span>
    #                         </span>
    #                     </a>
    #                     <a href="<%= url_for('/publications/make_talk/')%><%= $obj->{id} %><%=$burl%>" class="btn <%=$t2%> btn-sm" data-toggle="tooltip" data-placement="top" title="Click to set entry type to TALK<%=$extra_msg%>" data-container="body">
